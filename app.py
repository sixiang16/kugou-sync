#!/usr/bin/env python3
"""
酷狗歌单同步服务 + Web 控制面板（最终整合版）
- 导入：一次性使用 Cookie 拉取所有歌单，保存到本地
- 下载：使用 musicapi 的 gateway 接口，无需 Cookie
- 管理：手动添加/删除歌单，定时同步
"""
...
# ============================================================
# 获取歌单歌曲（gatewayretry 接口，无需 Cookie）
# ============================================================
def get_songs(pid):
